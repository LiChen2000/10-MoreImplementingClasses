...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        rec1point1 = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        rec1point2 = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        rec2point1 = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y - letter_thickness/2)
        rec2point2 = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y+(height-letter_thickness/2))
        rec1 = rg.Rectangle(rec1point1, rec1point2)
        rec2 = rg.Rectangle(rec2point1, rec2point2)
        self.h_rect = rec1
        self.v_rect = rec2
    ...
    def clone(self):
        t2 = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(), self.v_rect.get_height(),
